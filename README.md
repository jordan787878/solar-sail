...
Below, we show the animation of the (blue) ideal trajectory generated by the motion planner, and (red) run-time trajectory using motion planner and LQR to address process noise.
